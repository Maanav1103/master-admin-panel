...
import { Loader2, X, Check, Link, Code, Eye, Pencil } from "lucide-react";
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 space-y-3">
              ...
              {isEditing ? (
                ...
                <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 min-h-[280px]">
                  <div className="text-sm text-gray-500">Content will be displayed here when editing is enabled</div>
                </div>
              )}
          ...
          <div className="space-y-5">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <input type="text" placeholder="e.g. privacy, legal" disabled={!isEditing} {...register("metaTag")} className={inputBase} />
                {errors.metaTag && <p className="text-xs text-red-500">{errors.metaTag.message}</p>}
              </div>

              <div className="space-y-1.5">
                <label className="text-sm font-medium text-gray-700">Meta Title</label>
                <input type="text" placeholder="SEO page title" disabled={!isEditing} {...register("metaTitle")} className={inputBase} />
